...
public class PatientController {
	...
	public PatientController(int id) throws RemoteException {
		...
		// Invoking the service
		PatientStub.GetSurnameResponse responseSurname = stub
				.getSurname(requestSurName);
		...
		// Invoking the service
		PatientStub.GetStatusResponse responseStatus = stub
		...
		// Invoking the service
		PatientStub.GetIsHarmfulResponse responseHarmful = stub
				.getIsHarmful(requestHarmful);
		...
		// Invoking the service
		PatientStub.GetReasonResponse responseReason = stub
				.getReason(requestReason);
		...
		// Invoking the service
		PatientStub.GetAllergiesResponse responseAllergies = stub
				.getAllergies(requestAllergies);
		...
		// Invoking the service
		PatientStub.GetDetailsResponse responseDetails = stub
		...
		// Invoking the service
		PatientStub.GetTreatmentResponse responseTreatment = stub
				.getTreatment(requestTreatment);
		...
		// Invoking the service
		PatientStub.GetDiagnosisResponse responseDiagnosis = stub
				.getDiagnosis(requestDiagnosis);
		...
		// Invoking the service
		PatientStub.GetCommentsResponse responseComments = stub
				.getComments(requestComments);
